...
Tags: popup contact, popup form, popup, contact form plugin, contact form, easy contact, easy contact form solution, form solution, form builder, feedback 
Requires at least: 3.5.0
Tested up to: 3.5.1
Stable tag: 1.2

Contact Popup plugin, that allow you to create Contact form according to your requirement.
